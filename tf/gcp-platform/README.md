...
- `nixbot tf-platform`
- or local wrapper: `nixbot tofu -chdir=tf/gcp-platform plan`

Backend:

- this project uses GCS state
- `nixbot` auto-loads `GCP_STATE_BUCKET` from
...
- `nixbot` auto-loads `GCP_BACKEND_IMPERSONATE_SERVICE_ACCOUNT` from
