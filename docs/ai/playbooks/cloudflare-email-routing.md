...
7. Run `nixbot tf-platform --dry` again to confirm the address now shows as
   verified.
...
7. Run `nixbot tf-platform --dry`.
8. Run `nixbot tf-platform`.
...
1. Run `nixbot tf-platform --dry`.
2. Run `nixbot tf-platform`.
