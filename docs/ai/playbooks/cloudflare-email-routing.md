...
3. Run `./scripts/nixbot.sh run --action tf-platform --dry`.
4. Run `./scripts/nixbot.sh run --action tf-platform`.
5. Wait for Cloudflare to send the verification email.
6. Open the verification email and complete the confirmation link.
7. Run `./scripts/nixbot.sh run --action tf-platform --dry` again to confirm the
...
7. Run `./scripts/nixbot.sh run --action tf-platform --dry`.
8. Run `./scripts/nixbot.sh run --action tf-platform`.
...
1. Run `./scripts/nixbot.sh run --action tf-platform --dry`.
2. Run `./scripts/nixbot.sh run --action tf-platform`.
