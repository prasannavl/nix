...
- Date: 2026-04-08
- Scope: `tf/modules/cloudflare/scripts/worker-dir-nix-resolver.sh`,
  direct Wrangler helpers under `pkgs/cloudflare-apps/*`, root package
...
developer UX outside this workflow and should not be part of Terraform app
build resolution.
