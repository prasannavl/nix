...
- `docs/ai/notes/lib/ext-package-move-2026-04.md`: Move standalone overlay-fed
  derivation definitions from `pkgs/ext` to `lib/ext` and update direct repo
  references.
- `docs/ai/notes/lib/flake-collections-lib-location-2026-04.md`: Move the shared
  collections helper to `lib/flake/collections` and update in-repo imports to
  use the new path.
