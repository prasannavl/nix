{
  ...
  username = userdata.pvl.username;
in {
    ...
    let
      mods = import ../../modules {
        ...
        modules = [
          ...
          {
            path = ../../modules/gnome-wallpaper.nix;
            args = {wallpaperUri = "file://${config.home.homeDirectory}/src/dotfiles/x/files/backgrounds/sw.png";};
          }
        ];
      };
