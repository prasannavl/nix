let
  baseProfile = import ./default.nix;
in {
  nixos = {...}: {};
  ...
  home = {
    ...
    inherit (baseProfile) baseConfig sensibleConfig;
    ...
    pluginSpecs = {
      ...
      snacks = {
        ...
        config = ''
          ...
          local function picker_map(lhs, source, desc, mode)
            map(mode or "n", lhs, function()
              Snacks.picker[source]()
            end, { desc = desc })
          end

          -- Top-level navigation.
          picker_map("<leader><space>", "files", "Find files")
          picker_map("<leader>,", "buffers", "Buffers")
          picker_map("<leader>/", "grep", "Grep")
          picker_map("<leader>:", "command_history", "Command history")
          map("n", "<leader>e", function()
            Snacks.explorer()
          end, { desc = "Explorer" })

          -- Find files and navigation targets.
          picker_map("<leader>fb", "buffers", "Buffers")
          picker_map("<leader>ff", "files", "Files")
          picker_map("<leader>fg", "git_files", "Git files")
          picker_map("<leader>fp", "projects", "Projects")
          picker_map("<leader>fr", "recent", "Recent files")

          -- Git repository state and history.
          picker_map("<leader>g/", "git_grep", "Grep")
          picker_map("<leader>gb", "git_branches", "Branches")
          picker_map("<leader>gd", "git_diff", "Diff hunks")
          picker_map("<leader>gf", "git_log_file", "File history")
          picker_map("<leader>gl", "git_log", "Log")
          picker_map("<leader>gL", "git_log_line", "Line history")
          picker_map("<leader>gs", "git_status", "Status")
          picker_map("<leader>gS", "git_stash", "Stash")
          map("n", "<leader>gg", function()
            Snacks.lazygit()
          end, { desc = "Lazygit" })

          -- Search text and editor state.
          picker_map("<leader>s/", "search_history", "Search history")
          picker_map("<leader>sb", "lines", "Buffer lines")
          picker_map("<leader>sB", "grep_buffers", "Open buffer text")
          picker_map("<leader>sc", "commands", "Commands")
          picker_map("<leader>sd", "diagnostics", "Diagnostics")
          picker_map("<leader>sg", "grep", "Grep")
          picker_map("<leader>sh", "help", "Help")
          picker_map("<leader>sj", "jumps", "Jumps")
          picker_map("<leader>sk", "keymaps", "Keymaps")
          picker_map("<leader>sl", "loclist", "Location list")
          picker_map("<leader>sm", "marks", "Marks")
          picker_map("<leader>sq", "qflist", "Quickfix list")
          picker_map("<leader>sR", "resume", "Resume picker")
          picker_map("<leader>ss", "lsp_symbols", "Document symbols")
          picker_map("<leader>sS", "lsp_workspace_symbols", "Workspace symbols")
          picker_map("<leader>sw", "grep_word", "Word or selection", { "n", "x" })
